...
# sudo ./SCRIPTNAME.sh
#
# SCRIPT: elk-stack-v7_security-freebsd-13.sh
...
# PLATFORM: FreeBSD 13
#
# PURPOSE: This script installs NGINX as a reverse proxy for the ELK stack version 7 on a FreeBSD 13 system
# and provides TLS connectivity.
#
# REV LIST:
# DATE: 
# BY: ALBERT VALBUENA
